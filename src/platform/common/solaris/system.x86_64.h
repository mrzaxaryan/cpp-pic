 ...
 * @brief x86_64 Solaris syscall implementation via inline assembly.
 *
 ...
 * convention as Linux (rdi, rsi, rdx, r10, r8, r9; number in rax), but Solaris
...
public:
	...
	// under LTO, which causes miscompilation due to carry-flag + "+r"(rdx) constraints.
