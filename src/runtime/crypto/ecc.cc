...
Result<void, Error> ECC::Initialize(INT32 bytes)
{
	...
	if (bytes == SECP256R1)
	{
		auto pEmbed = MakeEmbedArray<UINT64>(0xFFFFFFFFFFFFFFFF, 0x00000000FFFFFFFF, 0x0000000000000000, 0xFFFFFFFF00000001);
		auto bEmbed = MakeEmbedArray<UINT64>(0x3BCE3C3E27D2604B, 0x651D06B0CC53B0F6, 0xB3EBBD55769886BC, 0x5AC635D8AA3A93E7);
		auto gxEmbed = MakeEmbedArray<UINT64>(0xF4A13945D898C296, 0x77037D812DEB33A0, 0xF8BCE6E563A440F2, 0x6B17D1F2E12C4247);
		auto gyEmbed = MakeEmbedArray<UINT64>(0xCBB6406837BF51F5, 0x2BCE33576B315ECE, 0x8EE7EB4A7C0F9E16, 0x4FE342E2FE1A7F9B);
		auto nEmbed = MakeEmbedArray<UINT64>(0xF3B9CAC2FC632551, 0xBCE6FAADA7179E84, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFF00000000);
		Memory::Copy(this->curveP, (PCVOID)pEmbed, sizeof(this->curveP));
		Memory::Copy(this->curveB, (PCVOID)bEmbed, sizeof(this->curveB));
		Memory::Copy(this->curveG.X, (PCVOID)gxEmbed, sizeof(this->curveG.X));
		Memory::Copy(this->curveG.Y, (PCVOID)gyEmbed, sizeof(this->curveG.Y));
		Memory::Copy(this->curveN, (PCVOID)nEmbed, sizeof(this->curveN));
	}
	else if (bytes == SECP384R1)
	{
		auto pEmbed = MakeEmbedArray<UINT64>(0x00000000FFFFFFFF, 0xFFFFFFFF00000000, 0xFFFFFFFFFFFFFFFE, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF);
		auto bEmbed = MakeEmbedArray<UINT64>(0x2A85C8EDD3EC2AEF, 0xC656398D8A2ED19D, 0x0314088F5013875A, 0x181D9C6EFE814112, 0x988E056BE3F82D19, 0xB3312FA7E23EE7E4);
		auto gxEmbed = MakeEmbedArray<UINT64>(0x3A545E3872760AB7, 0x5502F25DBF55296C, 0x59F741E082542A38, 0x6E1D3B628BA79B98, 0x8EB1C71EF320AD74, 0xAA87CA22BE8B0537);
		auto gyEmbed = MakeEmbedArray<UINT64>(0x7A431D7C90EA0E5F, 0x0A60B1CE1D7E819D, 0xE9DA3113B5F0B8C0, 0xF8F41DBD289A147C, 0x5D9E98BF9292DC29, 0x3617DE4A96262C6F);
		auto nEmbed = MakeEmbedArray<UINT64>(0xECEC196ACCC52973, 0x581A0DB248B0A77A, 0xC7634D81F4372DDF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF);
		Memory::Copy(this->curveP, (PCVOID)pEmbed, sizeof(this->curveP));
		Memory::Copy(this->curveB, (PCVOID)bEmbed, sizeof(this->curveB));
		Memory::Copy(this->curveG.X, (PCVOID)gxEmbed, sizeof(this->curveG.X));
		Memory::Copy(this->curveG.Y, (PCVOID)gyEmbed, sizeof(this->curveG.Y));
