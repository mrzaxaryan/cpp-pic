...
Position-Independent Runtime (PIR) is designed for **legitimate security research, authorized penetration testing, embedded systems development, and educational purposes**. Users must ensure they have proper authorization before deploying PIR in any environment.
...
If you discover a security vulnerability in PIR, please report it **privately** rather than opening a public issue.

### How to Report

1. **Email:** Send a detailed report to the project maintainer (see GitHub profile for contact information)
2. **GitHub Security Advisories:** Use [GitHub's private vulnerability reporting](https://github.com/mrzaxaryan/Position-Independent-Runtime/security/advisories/new) to submit a confidential advisory
...
- Vulnerabilities in PIR's cryptographic implementations (SHA-2, ChaCha20-Poly1305, ECC, TLS 1.3)
...
- Vulnerabilities in the Windows syscall/NTAPI wrappers

The following are **out of scope**:

- Issues in third-party tools (LLVM, CMake, Ninja)
- Misuse of PIR for unauthorized purposes
